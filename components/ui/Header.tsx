  ...
  return (
    <header className="absolute top-0 left-0 w-full p-6 z-50 flex justify-between items-center pointer-events-none mix-blend-difference border-b border-white/5">
      <div className="flex items-center gap-3 md:gap-6">
        <h1 className="text-[10px] md:text-xs font-bold tracking-[0.4em] uppercase pointer-events-auto cursor-pointer">
          AXYNC<span className="font-light text-white/40">_CORE</span>
        </h1>
