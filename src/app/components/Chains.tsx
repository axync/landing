...
export function Chains() {
  return (
    <section id="chains" className="mx-auto max-w-6xl px-6 py-32">
      ...
      <StaggerContainer className="mt-16 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
        {chains.map((chain) => (
          <StaggerItem
            key={chain.name}
            className="glass card-glow flex flex-col items-center gap-3 rounded-xl p-6"
          >
      ...
      <FadeIn delay={0.2} className="mt-8 text-center text-sm text-text-dim">
